    ...
    class ImportFormsData
    {
        static void Main(string[] args)
        {
            ...
            using (Library lib = new Library(LibraryFlags.InitFormsExtension))
            {
                ...
                sInputData = Library.ResourceDirectory + "Sample_Input/AcroForm_data.pdf";
                ...
                using (Document doc = new Document(sInput))
                {
                    //Import the data while specifying the type, in this case PDF
                    bool result = doc.ImportAcroFormsData(sInputData, AcroFormImportType.PDF);
